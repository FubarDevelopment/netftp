...
namespace System.Net.FtpClient {
    ...
    public class FtpClient : IFtpClient {
        ...
        private SslProtocols m_SslProtocols = FtpSocketStream.DefaultSslProtocols;
        /// <summary>
        ...
        protected FtpClient CloneConnection() {
            ...
            foreach (PropertyInfo prop in GetType().GetProperties()) {
                var attributes = prop.GetCustomAttributes(typeof(FtpControlConnectionClone), true);
